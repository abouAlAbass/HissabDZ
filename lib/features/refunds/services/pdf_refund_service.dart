...
class PdfRefundService {
  ...
  static Future<File> generateRefundPdf({
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          _header(refund, invoice, profile, logoImage, dateFormat, l10n, isRtl),
          pw.SizedBox(height: 16),
          _infoRow(refund, invoice, dateFormat, l10n, isRtl),
          pw.SizedBox(height: 20),
          _itemsTable(refund, currencyFormat, l10n, textDirection),
          pw.SizedBox(height: 18),
          _totals(refund, invoice, currencyFormat, l10n, isRtl),
        ],
  ...
  static pw.Widget _itemsTable(
    ...
    final rows = refund.items.map((item) {
      return [
        item.description ?? '',
